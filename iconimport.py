...
class FailureInjectorApp:
    def __init__(self, master):
        ...
        self.master.iconbitmap('aircraft.ico')  # Set your icon here
        self.running = False
        self.thread = None
        self.registration = REGISTRATION_CODE
